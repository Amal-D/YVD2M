package me.amald.youtubedownloader.Util.custom;
...
import me.amald.youtubedownloader.Util.WrapViewPager;
...
public class NavigationTabStrip extends View implements ViewPager.OnPageChangeListener {
    ...
    private final static int DEFAULT_ACTIVE_COLOR = Color.TRANSPARENT;
    ...
    private final NavigationTabStrip.ResizeInterpolator mResizeInterpolator = new NavigationTabStrip.ResizeInterpolator();
    ...
    // Tab listener
    private NavigationTabStrip.OnTabStripSelectedIndexListener mOnTabStripSelectedIndexListener;
    ...
    private NavigationTabStrip.StripType mStripType;
    private NavigationTabStrip.StripGravity mStripGravity;
    ...
    public NavigationTabStrip(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        try {
            ...
            setStripType(
                    typedArray.getInt(R.styleable.NavigationTabStrip_nts_type, NavigationTabStrip.StripType.LINE_INDEX)
            );
            setStripGravity(
                    typedArray.getInt(R.styleable.NavigationTabStrip_nts_gravity, NavigationTabStrip.StripGravity.BOTTOM_INDEX)
            );
    ...
    private void setStripGravity(final int index) {
        switch (index) {
            case NavigationTabStrip.StripGravity.TOP_INDEX:
                setStripGravity(NavigationTabStrip.StripGravity.TOP);
                break;
            case NavigationTabStrip.StripGravity.BOTTOM_INDEX:
            default:
                setStripGravity(NavigationTabStrip.StripGravity.BOTTOM);
                break;
        }
    }

    public void setStripGravity(final NavigationTabStrip.StripGravity stripGravity) {
    ...
    private void setStripType(final int index) {
        switch (index) {
            case NavigationTabStrip.StripType.POINT_INDEX:
                setStripType(NavigationTabStrip.StripType.POINT);
                break;
            case NavigationTabStrip.StripType.LINE_INDEX:
            default:
                setStripType(NavigationTabStrip.StripType.LINE);
                break;
        }
    }

    public void setStripType(final NavigationTabStrip.StripType stripType) {
    ...
    public NavigationTabStrip.OnTabStripSelectedIndexListener getOnTabStripSelectedIndexListener() {
    ...
    public void setOnTabStripSelectedIndexListener(final NavigationTabStrip.OnTabStripSelectedIndexListener onTabStripSelectedIndexListener) {
    ...
    private void resetScroller() {
        ...
        try {
            ...
            final NavigationTabStrip.ResizeViewPagerScroller scroller = new NavigationTabStrip.ResizeViewPagerScroller(getContext());
    ...
    public void setTabIndex(int tabIndex, boolean isForce) {
        ...
        mEndStripX = (mIndex * mTabSize) + (mStripType == NavigationTabStrip.StripType.POINT ? mTabSize * 0.5F : 0.0F);
    ...
    private void updateIndicatorPosition(final float fraction) {
        ...
        mStripRight =
                (mStartStripX + (mStripType == NavigationTabStrip.StripType.LINE ? mTabSize : mStripWeight)) +
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (isInEditMode() || !mIsViewPagerMode) {
            ...
            mStartStripX =
                    (mIndex * mTabSize) + (mStripType == NavigationTabStrip.StripType.POINT ? mTabSize * 0.5F : 0.0F);
            mEndStripX = mStartStripX;
            updateIndicatorPosition(MAX_FRACTION);
        }
    }
    ...
    protected void onDraw(final Canvas canvas) {
        // Set bound of strip
        mStripBounds.set(
                mStripLeft - (mStripType == NavigationTabStrip.StripType.POINT ? mStripWeight * 0.5F : 0.0F),
                mStripGravity == NavigationTabStrip.StripGravity.BOTTOM ? mBounds.height() - mStripWeight : 0.0F,
                mStripRight - (mStripType == NavigationTabStrip.StripType.POINT ? mStripWeight * 0.5F : 0.0F),
                mStripGravity == NavigationTabStrip.StripGravity.BOTTOM ? mBounds.height() : mStripWeight
        );
        ...
        for (int i = 0; i < mTitles.length; i++) {
            ...
            canvas.drawText(
                    ...
                    topTitleOffset + (mStripGravity == NavigationTabStrip.StripGravity.TOP ? mStripWeight : 0.0F),
                    mTitlePaint
            );
        }
    }
    ...
    public void onPageScrolled(int position, float positionOffset, final int positionOffsetPixels) {
        ...
        if (!mIsSetIndexFromTabBar) {
            ...
            mStartStripX =
                    (position * mTabSize) + (mStripType == NavigationTabStrip.StripType.POINT ? mTabSize * 0.5F : 0.0F);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        final NavigationTabStrip.SavedState savedState = (NavigationTabStrip.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        final NavigationTabStrip.SavedState savedState = new NavigationTabStrip.SavedState(superState);
